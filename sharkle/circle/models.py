...
class Circle(BaseModel):
    ...
    type0 = models.PositiveSmallIntegerField(choices=CircleType0.choices, default=CircleType0.기타)
    ...
    type1 = models.PositiveSmallIntegerField(choices=CircleType1.choices, default=CircleType1.기타)
